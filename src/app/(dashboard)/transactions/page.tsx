...
export default async function TransactionsPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="max-w-md text-center bg-white border border-zinc-100 rounded-2xl p-8">
          ...
          <p className="text-sm text-zinc-500 mb-6">Create your account to start tracking transactions.</p>
  ...
  return (
    <div className="min-h-screen pb-6 md:pb-8">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-10 py-5 md:py-6">
        <TransactionsList
